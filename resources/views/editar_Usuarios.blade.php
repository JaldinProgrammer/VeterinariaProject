...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Edicion del usuario '. $user->name) }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('update_Users', $user->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                               ...
                               <br><br>
                               <input type="radio" name="rol" value="veter">Veterinario
                               <br><br>
                               <input type="radio" name="rol" value="clien">Cliente
                            </div>
                        </div>
